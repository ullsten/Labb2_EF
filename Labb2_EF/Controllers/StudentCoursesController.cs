...
namespace Labb2_EF.Controllers
{
    public class StudentCoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentCourseId,FK_StudentId,FK_CourseId,Grade")] StudentCourse studentCourse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("StudentCourseId,FK_StudentId,FK_CourseId,Grade")] StudentCourse studentCourse)
        {
