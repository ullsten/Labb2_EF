...
namespace Labb2_EF.Controllers
{
    public class StudentCoursesController : Controller
    {
        ...
        {
            var schoolDbContext = _context.StudentTeachersCourses.Include(s => s.Courses).Include(s => s.Students);
        ...
        {
            if (id == null || _context.StudentTeachersCourses == null)
            {
                return NotFound();
            }

            var studentCourse = await _context.StudentTeachersCourses
                .Include(s => s.Courses)
       ...
       [HttpPost]
        ...
        public async Task<IActionResult> Edit(Guid? id)
        {
            ...
            var studentCourse = await _context.StudentTeachersCourses.FindAsync(id);
            if (studentCourse == null)
            {
                return NotFound();
            }
        ...
        {
            if (_context.StudentTeachersCourses == null)
            {
            ...
            if (studentCourse != null)
            {
                _context.StudentTeachersCourses.Remove(studentCourse);
            }
        ...
        {
            return (_context.StudentTeachersCourses?.Any(e => e.StudentCourseId == id)).GetValueOrDefault();
        }
    }
}
